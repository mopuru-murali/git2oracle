...
class GitDao(object):
    ...
    def insert_commit_parents(self, parents, commit_id, sha, repo_id):
        ...
        for parent in parents:
            ...
            query = "INSERT INTO commit_parent " \
                    "VALUES (:repo_id, :commit_id, :sha, :parent_id, :parent_sha)"
    ...
    def insert_commit_in_reference(self, repo_id, commit_id, ref_id):
        ...
        query = "INSERT INTO commit_in_reference " \
                "VALUES (:repo_id, :commit_id, :ref_id)"
    ...
    def insert_file_modification(self, commit_id, file_id, status, additions, deletions, changes, patch_content):
        ...
        """
        cursor = self._cnx.cursor()
        query = "INSERT INTO file_modification(commit_id, file_id, status, additions, deletions, changes, patch) " \
                "VALUES (:commit_id, :file_id, :status, :additions, :deletions, :changes, :patch_content)"
    ...
    def insert_file_renamed(self, repo_id, current_file_id, previous_file_id):
        ...
        query = "INSERT IGNORE INTO file_renamed " \
                "VALUES (:repo_id, :current_file_id, :previous_file_id)"
    ...
    def insert_file(self, repo_id, name, ext):
        ...
        """
        cursor = self._cnx.cursor()
        query = "INSERT INTO files(repo_id, name, ext) " \
                "VALUES (:repo_id, :name, :ext)"
        arguments = [repo_id, name, ext]
        cursor.execute(query, arguments)
        self._cnx.commit()
        cursor.close()
    ...
    def select_file_id(self, repo_id, name):
        ...
        query = "SELECT id " \
                "FROM files " \
                "WHERE name = :name AND repo_id = :repo_id"
        arguments = [name, repo_id]
        cursor.execute(query, arguments)
        try:
            id = cursor.fetchone()[0]
    ...
    def insert_reference(self, repo_id, ref_name, ref_type):
        ...
        """
        cursor = self._cnx.cursor()
        query = "INSERT INTO reference(repo_id, name, type) " \
                "VALUES (:repo_id, :ref_name, :ref_type)"
        arguments = [repo_id, ref_name, ref_type]
        cursor.execute(query, arguments)
        self._cnx.commit()
        cursor.close()
    ...
    def select_reference_id(self, repo_id, ref_name):
        ...
        query = "SELECT id " \
                "FROM reference " \
                "WHERE name = :ref_name and repo_id = :repo_id"
    ...
    def insert_commit(self, repo_id, sha, message, author_id, committer_id, authored_date, committed_date, size):
        ...
        """
        cursor = self._cnx.cursor()
        query = "INSERT INTO commits(repo_id, sha, message, author_id," \
                "committer_id, authored_date, committed_date, commit_size) " \
                "VALUES (:repo_id, :sha, :message, :author_id," \
                ":committer_id, :authored_date, :committed_date, :commit_size)"
    ...
    def fix_commit_parent_table(self, repo_id):
        ...
        query_select = "SELECT parent_sha " \
                       "FROM commit_parent " \
                       "WHERE parent_id IS NULL AND repo_id = :repo_id"
        cursor.execute(query_select, [repo_id])
        row = cursor.fetchone()
        while row:
            parent_sha = row[0]
    ...
    def select_commit_id(self, sha, repo_id):
        ...
        query = "SELECT id " \
                "FROM commits " \
                "WHERE sha = :sha AND repo_id = :repo_id"
